"""Shared pytest fixtures for the `hack` test suite.

All fixtures live here so test classes across the package can reuse them without
duplicating construction logic. Tests themselves remain class-based
(`class TestXxx:`); only fixture construction is consolidated.
"""
